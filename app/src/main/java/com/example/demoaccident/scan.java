...
public class scan extends AppCompatActivity{
    ...
    protected void onStart() {
        ...
        if(bluetooth.isEnabled()){
            ...
            bluetooth.showEnableDialog(scan.this);
        }
    }
    ...
    private BluetoothCallback bluetoothCallback = new BluetoothCallback() {
        ...
        public void onUserDeniedActivation() {
            Toast.makeText(scan.this, "I need to activate bluetooth...", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private DiscoveryCallback discoveryCallback = new DiscoveryCallback() {
        ...
        public void onDevicePaired(BluetoothDevice device) {
            Toast.makeText(scan.this, "Paired !", Toast.LENGTH_SHORT).show();
